...
SocketCreate: function(url)
{
	...
	socket.socket.onmessage = function (e) {
		...
		{
			// console.log("blob receive.");
			var reader = new FileReader();
			reader.addEventListener("loadend", function() {
				//console.log("webSocket receive: " + reader.result);
		...
		{
			//console.log("arrayBuffer receive.");
			var array = new UnUint8Array(e.data);
			socket.message.push(array);
		}
